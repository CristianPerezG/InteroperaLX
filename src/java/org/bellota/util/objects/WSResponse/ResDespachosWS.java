...
public class ResDespachosWS {
    ...
    private List<ReqDespachosWS> Transacciones;
    ...
    public List<ReqDespachosWS> getTransacciones() {
        return Transacciones;
    }

    public void setTransacciones(List<ReqDespachosWS> Transacciones) {
