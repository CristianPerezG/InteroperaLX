...
public class ConectorAS400 {
    ...
    public ConectorAS400(Connection conexionSolicitada, String querySolicitado) throws SQLException {

        this.conexionAS400 = conexionSolicitada;
        this.queryDB2 = querySolicitado;

        try {
            Statement st = conexionAS400.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ...
    public String[] obtenerNombresColumnas() {
        try {
            numColumnas = metaDataResultado.getColumnCount();
            ...
            Logger.getLogger(ConectorAS400.class.getName()).log(Level.SEVERE, null, ex);
        }
